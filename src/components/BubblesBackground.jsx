...
const BubblesBackground = () => {
  ...
  const particleColors = useMemo(() => {
    ...
    return {
      canvas: root.getPropertyValue("--color-particle-canvas").trim() || "#06090f",
      dot: root.getPropertyValue("--color-particle-dot").trim() || "#ffffff",
      link: root.getPropertyValue("--color-particle-link").trim() || "#ffffff",
    };
  }, [isDark]);
    ...
    () => ({
      ...
      particles: {
        ...
        move: {
          ...
          random: false, size: false, speed: 2,
        ...
        opacity: {
          value: { min: isDark ? 0.1 : 0.15, max: isDark ? 0.5 : 0.45 },
          animation: {
            count: 0, enable: true, speed: 3, decay: 0, delay: 0,
        ...
        size: {
          value: { min: 1, max: 10 },
          animation: {
            count: 0, enable: true, speed: 20, decay: 0, delay: 0,
            sync: false, mode: "auto", startValue: "random", destroy: "none",
          },
        },
        stroke: { width: 0 },
        ...
        links: {
          blink: false,
          color: { value: particleColors.link },
          consent: false,
          distance: 150,
          enable: true,
          frequency: 1,
